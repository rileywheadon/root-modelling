...
\abstract{Variations in the rates of cell division and elongation in the root apical meristem of \emph{A. thaliana} have a significant influence on organ development.
...
Fitting the model to experimental data reveals that both superphysiological and supraphysiological concentrations of CLASP inhibit cell division.
These findings suggest that the efficient relocalization of microtubules between phases of the cell cycle requires the CLASP protein to be well-regulated.}
